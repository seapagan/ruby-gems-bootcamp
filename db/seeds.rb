...
# User.create(email: 'student@example.com', password: 'student@example.com',
...
Service.create(name: 'Massage', duration: 45, client_price: 50)
Service.create(name: 'Yoga', duration: 45, client_price: 30)
